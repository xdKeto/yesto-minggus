...
const Contacts = () => {
  return (
    <section className="min-h-screen flex flex-col justify-center px-4 md:px-10" id="contact">
      ...
      <motion.h3 className="text-falu text-6xl md:text-8xl leading-none font-semibold drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]" initial="hidden" whileInView="visible" custom={0.4} variants={textVariants}>
